...
<body id="page-top" onload="doOnLoad();">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-gray sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item <?php if(isset($_GET['laptop'])){ echo "active"; }?>">
        <a class="nav-link" href="?laptop">
          <i class="fas fa-laptop"></i>
          <span>Desktop and Laptop</span></a>
      </li>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body align-center">
                    <div class='container-fluid'>
                        ...
                        <div class='row p-2'>
                            <div class='col'style='font-size:12px'>
                                <b>From</b> : <br><input type='text' name='dateFrom' required>
                            </div>
                            <div class='col' style='font-size:12px'>
                                <b>To</b> : <br><input type='text' name='dateTo' required>
                            </div>
                        </div>
                        <div class='row p-2' style='background:#f5f5f5'>
                            <div class='col' style='font-size:12px'>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Total Philippines IT Team <?php echo date('Y')?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
